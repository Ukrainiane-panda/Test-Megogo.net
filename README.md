# Megogo.net
Лінк на виконане завдання:
https://test-megogo-ukrainian-e-panda.netlify.app/
...
Основні вимоги:
1) Поeкранний скролл. Дизайн передбачає чітке розділення між екранами (можна
використовувати бібліотеки чи плагіни).
2) Екран повинен бути адаптивним і займати увесь розмір “viewport” мобільного
